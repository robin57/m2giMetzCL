...
public class NavigationDrawerManager extends AppCompatActivity
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_messages) {
            ...
            // open the drawPad
            fragmentManager.beginTransaction().replace(R.id.content_frame,new DrawPadFragment()).commit();
            setTitle("DrawPad");
        } else if (id == R.id.nav_buddy_list) {
            // open the BuddyList
